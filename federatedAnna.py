...
def main():
    ...
    if version == '1':
        ...
        partition_of_training_data = torch.utils.data.random_split(label_zero_subset, [5023, 100, 100, 100, 100, 100, 100, 100, 100, 100]) # 5023 + 9*100 = 5923
        ...
        partition_of_training_data2 = torch.utils.data.random_split(label_not_zero_subset, [977, 5900, 5900, 5900, 5900, 5900, 5900, 5900, 5900, 5900]) # 977 + 9*5900 = 54077
        ...
        partition_of_training_data0 = torch.utils.data.random_split(label_zero_subset, [5023, 100, 100, 100, 100, 100, 100, 100, 100, 100])
        partition_of_training_data1 = torch.utils.data.random_split(label_one_subset, [100, 5842, 100, 100, 100, 100, 100, 100, 100, 100])
        partition_of_training_data2 = torch.utils.data.random_split(label_two_subset, [100, 100, 5058, 100, 100, 100, 100, 100, 100, 100])
        partition_of_training_data3 = torch.utils.data.random_split(label_three_subset, [100, 100, 100, 5231, 100, 100, 100, 100, 100, 100])
        partition_of_training_data4 = torch.utils.data.random_split(label_four_subset, [100, 100, 100, 100, 4942, 100, 100, 100, 100, 100])
        partition_of_training_data5 = torch.utils.data.random_split(label_five_subset, [100, 100, 100, 100, 100, 4521, 100, 100, 100, 100])
        partition_of_training_data6 = torch.utils.data.random_split(label_six_subset, [100, 100, 100, 100, 100, 100, 5018, 100, 100, 100])
        partition_of_training_data7 = torch.utils.data.random_split(label_seven_subset, [100, 100, 100, 100, 100, 100, 100, 5365, 100, 100])
        partition_of_training_data8 = torch.utils.data.random_split(label_eight_subset, [100, 100, 100, 100, 100, 100, 100, 100, 4951, 100])
        partition_of_training_data9 = torch.utils.data.random_split(label_nine_subset, [100, 100, 100, 100, 100, 100, 100, 100, 100, 5049]) 

        #concat datasets
        new_dataset_list = []
        for i in range(10):
            new_dataset_list.append(torch.utils.data.ConcatDataset([partition_of_training_data0[i], partition_of_training_data1[i], partition_of_training_data2[i],
        ...
        new_dataset_list = torch.utils.data.random_split(dataset_training, [int(dataset_training.data.shape[0] / numberOfClients) for _ in range(numberOfClients)])
